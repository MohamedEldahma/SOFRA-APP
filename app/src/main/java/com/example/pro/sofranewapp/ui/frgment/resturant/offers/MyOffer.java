...
public class MyOffer extends Fragment {
    ...
    Unbinder unbinder;
    @BindView(R.id.bttadd_new_offer)
    Button bttaddNewOffer;
    ...
    @OnClick(R.id.bttadd_new_offer)
    public void onViewClicked() {
        HelperMethod.replaceFrag(new AddNewOfferResturantFragment(),((FragmentActivity)getContext())
