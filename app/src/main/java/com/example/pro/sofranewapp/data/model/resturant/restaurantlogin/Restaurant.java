...
public class Restaurant {
    ...
    @Expose
    private RestLoginRegion region;
    @SerializedName("categories")
    @Expose
    private List<RestLoginCategory> categories = null;
    ...
    public RestLoginRegion getRegion() {
        return region;
    }

    public void setRegion(RestLoginRegion region) {
        this.region = region;
    }

    public List<RestLoginCategory> getCategories() {
        return categories;
    }

    public void setCategories(List<RestLoginCategory> categories) {
